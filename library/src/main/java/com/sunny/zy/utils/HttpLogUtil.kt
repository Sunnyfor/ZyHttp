...
object HttpLogUtil {
    ...
    private fun println(logType: Int, content: String) {
        ...
        when (logType) {
            VERBOSE -> Log.v(ZyHttpConfig.logTag, content)
            DEBUG -> Log.d(ZyHttpConfig.logTag, content)
            INFO -> Log.i(ZyHttpConfig.logTag, content)
            WARN -> Log.w(ZyHttpConfig.logTag, content)
            ERROR -> Log.e(ZyHttpConfig.logTag, content)
        }
    }
